...
/* BIP 369: Bitcoin-optimized SLH-DSA parameters.
 * Uses standard FIPS 205 algorithms (WOTS+, FORS) with custom tree parameters.
 * Signature size: 4080 bytes. Security: NIST Category 1 (128-bit classical). */
const slh_param_t slh_dsa_bitcoin = {/* .alg_id = */ "SLH-DSA-Bitcoin-128s",
                                     /* .n = */ 16,
                                     /* .h = */ 32,
                                     /* .d = */ 4,
                                     /* .hp = */ 8,
